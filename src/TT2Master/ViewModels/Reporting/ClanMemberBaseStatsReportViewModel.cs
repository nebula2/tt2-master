...
namespace TT2Master.ViewModels.Reporting
{
    ...
    /// Settings
    /// </summary>
    public class ClanMemberBaseStatsReportViewModel : ViewModelBase
    {
        #region Properties
        /// <summary>
        ...
        public ClanMemberBaseStatsReportViewModel(INavigationService navigationService, IPageDialogService dialogService) : base(navigationService)
        {
            _navigationService = navigationService;
            _dialogService = dialogService;

            Title = AppResources.MemberBaseStatsReport;
        }
        #endregion
