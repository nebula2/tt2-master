...
namespace TT2Master.ViewModels.Reporting
{
    ...
    /// Settings
    /// </summary>
    public class ClanMemberCompleteReportViewModel : ViewModelBase
    {
        #region Properties
        /// <summary>
        ...
        public ClanMemberCompleteReportViewModel(INavigationService navigationService, IPageDialogService dialogService) : base(navigationService)
        {
            _dialogService = dialogService;
            _navigationService = navigationService;


            Title = AppResources.CompleteMemberReport;
        }
        #endregion
