...
namespace TT2Master.Model.FilePicker
{
    /// <summary>
    ...
    public class FilePickerEventArgs : EventArgs
    {
        ...
        public FilePickerEventArgs(string fileName) => FileName = fileName;
        ...
        public FilePickerEventArgs(string fileName, string filePath) : this(fileName) => FilePath = filePath;
    }
}