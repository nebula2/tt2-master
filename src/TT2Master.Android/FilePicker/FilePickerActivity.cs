...
namespace TT2Master.Droid.FilePicker
{
    ...
    public class FilePickerActivity : Activity
    {
        ...
        /// </summary>
        private const int _requestStorage = 1;
        ...
        protected override void OnCreate(Bundle savedInstanceState)
        {
            ...
            else
            {
                ...
                {
                    RequestPermissions(new string[] { Manifest.Permission.ReadExternalStorage }, _requestStorage);
                }
                else
                {
        ...
        {
            if (requestCode == _requestStorage)
            {
        ...
        protected override void OnActivityResult(int requestCode, [GeneratedEnum] Result resultCode, Intent data)
        {
            ...
            else
            {
                try
                {
                    ...
                    var fileName = this.GetFileName(_context, uri);
        ...
        private string GetFileName(Context context, Android.Net.Uri uri)
        {
            ...
            else
            {
                ...
                return !string.IsNullOrEmpty(extension) ? "filename." + extension : Path.GetFileName(WebUtility.UrlDecode(uri.ToString()));
            }
        }
        ...
        private static void OnFilePicked(FilePickerEventArgs args) => FilePicked?.Invoke(null, args);
    }
}